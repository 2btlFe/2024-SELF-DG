...
def main():
    ...
    bi(batch_size=8)  # set to whatever works for your GPU
    ...
    prompt = "remove any descriptions of the style of the image, just leaving its content/objects, remove any mention of domain information like gta 5; gta; grand theft auto; gtav etc, must include {} for the following captions: \n "
